...
**Read.** Tap an article to open the reader: English summary, a 130-170 word Spanish *resumen* (with listen button)
...
```jsonc
{
  ...
  "resumen_es": "Mini-articulo en español de 130-170 palabras al nivel objetivo.",
